...
- [x] 4.6 Implement the public diagnostic reporter contract and integration-boundary delegation; verify missing or failing reporters do not change otherwise-valid setup behavior and no implicit `console` fallback is introduced.
